...
object BlasterItems {
	private fun registerBlaster(name: String, model: Int, maxPower: Int): BlasterItem {
	...
	fun register() {
		registerBlaster("Blaster Pistol", model = 1, maxPower = 2500)
		registerBlaster("Blaster Rifle", model = 2, maxPower = 7500)
		registerBlaster("Blaster Sniper", model = 3, maxPower = 20000)
		registerBlaster("Blaster Cannon", model = 4, maxPower = 25000)
	}
}
...
enum class BlasterType(
	...
	PISTOL(
		CustomItems["blaster_pistol"]!! as BlasterItem,
		speed = 1100.0,
		range = 50,
		thickness = 0.1,
		cooldown = 300,
	...
	RIFLE(
		CustomItems["blaster_rifle"]!! as BlasterItem,
		speed = 650.0,
		range = 75,
		thickness = 0.1,
		cooldown = 600,
	...
	SNIPER(
		CustomItems["blaster_sniper"]!! as BlasterItem,
		speed = 1100.0,
		range = 250,
		thickness = 0.2,
		cooldown = 2000,
	...
	CANNON(
		CustomItems["blaster_cannon"]!! as BlasterItem,
		speed = 450.0,
		range = 200,
		thickness = 0.2,
		cooldown = 500,
